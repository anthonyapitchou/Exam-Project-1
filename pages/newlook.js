export default function newlook() {
  ...
  <section class="new-look">
    ...
    <div class="looks-grid">
      ...
      <div class="photo4"> 
      <a href="https://www.farfetch.com/shopping/women/comme-des-garcons-play-x-converse-chuck-70-hi-multi-hearts-white-sneakers-item-16351319.aspx." target="_blank"> 
      ...
      <div class="photo5">
        <a href="chanel-suit.html"> <img src="assets/images/suit.jpg" alt="Chanel suit">
        </a>
        <p class="brand-name">Taken from Google</p>
      </div>

      <div class="photo6">
      <a href="https://www.vogue.com/fashion-shows/spring-2024-ready-to-wear/comme-des-garcons." target="_blank">
